...
/*runs add_line_after in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs print_document in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs append_line in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs remove_line in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs load_file in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs replace_text in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs highlight_text in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs remove_text in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*runs save_document in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
static int save_document_ui(Document *doc, char *input){ 
...
/*runs reset_document in the ui. It makes sure the
function fall is correct with the oorrect parameters*/
...
/*Checks to make sure function calls in the ui are properly 
spelled, and are an actual function in document.c. Returns
SUCCESS when they are, and FAILURE when they are not.*/
...
/*main method. The user interface can either be used with standard I/O, or
by I/O redirection, which is done by specifying a file to read from.*/
